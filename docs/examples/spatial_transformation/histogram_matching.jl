...
# Applying histogram matching on source image using reference image
...
plot(hist_sred,hist_rred,hist_tred, layout =(1,3),size=(1000,333),legend=false,title=["source" "reference" "histograms matched"])
...
plot(hist_sgreen,hist_rgreen,hist_tgreen, layout =(1,3),size=(1000,333),legend=false,title=["source" "reference" "histograms matched"])
...
plot(hist_sblue,hist_rblue,hist_tblue, layout =(1,3),size=(1000,333),legend=false,title=["source" "reference" "histograms matched"])
